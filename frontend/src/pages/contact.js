  ...
  return (
    <div id='contact' className='px-20 bg-custom-gradient1 text-white'>
      ...
      <div className='lg:grid lg:grid-cols-2'>
        ...
        <input className='w-full px-2 bg-gray-100 py-4 lg:mx-10    rounded-lg' placeholder='Email'/>
        <input className='w-full px-2 bg-gray-100 py-4 rounded-lg my-3' placeholder='Phone'/>
        <input className='w-full px-2 bg-gray-100 py-4 lg:mx-10 rounded-lg' placeholder='Subject'/>
      </div>
